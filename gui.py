...
class Application(tk.Tk):
    def __init__(self):
        ...
        self.wynagrodzenie = ttk.Spinbox(self.pracownicy, from_=1, to=999999, width=15)
        self.wynagrodzenie.insert(0,1)
        ...
        self.oplata = ttk.Spinbox(self.oplaty, from_=1, to=999999)
        self.oplata.insert(0,1)
        ...
        self.oplatamiesieczna = ttk.Spinbox(self.oplaty, width=15, from_=1, to=999999)
        self.oplatamiesieczna.insert(0,1)
